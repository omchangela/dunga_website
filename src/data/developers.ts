...
export const DEVELOPERS_DATA: DeveloperProfile[] = [
  {
    ...
    name: 'Senior Full-Stack Engineer (#DEV-101)',
    shortName: 'DEV-101',
    ...
    liveStatusText: 'Available for Immediate Onboarding',
    lastActiveAgo: '2m ago',
    currentSprintName: 'Ready for 1-Week Trial Sprint Kickoff',
    weeklyCommits: 28,
  ...
  },
  {
    ...
    name: 'Senior Frontend & UI/UX Specialist (#DEV-102)',
    shortName: 'DEV-102',
    ...
    availabilityTimeline: 'Immediate (24-48h)',
    liveStatusText: 'Available for Immediate Onboarding',
    lastActiveAgo: '4m ago',
    currentSprintName: 'Ready for Sub-Second Next.js & UI/UX Sprint',
    weeklyCommits: 34,
  ...
  },
  {
    ...
    name: 'Senior Backend & Cloud Architect (#DEV-103)',
    shortName: 'DEV-103',
    ...
    availabilityTimeline: 'In Active Client Project (Next Slot: Oct 1)',
    liveStatusText: 'Active in Client Sprint (85% Bandwidth)',
    lastActiveAgo: 'Just now',
    currentSprintName: 'Sprint #4 • Distributed Redis Queues & Payment Engine',
    weeklyCommits: 46,
    responseTimeMinutes: 15,
    onTimeDeliveryRate: 100,
    currentLoadPercentage: 85,
    hourlyRateINR: 1399,
    hourlyRateUSD: 19,
  ...
  },
  {
    ...
    name: 'Senior Flutter & Mobile Developer (#DEV-104)',
    shortName: 'DEV-104',
    ...
    availabilityTimeline: 'Freeing Up in 6 Days',
    liveStatusText: 'Wrapping Up Fleet GPS App (Handover Phase)',
    lastActiveAgo: '6m ago',
    currentSprintName: 'Finalizing Play Store Release & Offline Sync',
    weeklyCommits: 31,
  ...
  },
  {
    ...
    name: 'Senior AI / ML & Python Engineer (#DEV-105)',
    shortName: 'DEV-105',
    ...
    availabilityTimeline: 'Immediate (24-48h)',
    liveStatusText: 'Available for Immediate Onboarding',
    lastActiveAgo: '1m ago',
    currentSprintName: 'Ready for LLM RAG Agent & Vector DB Sprint',
    weeklyCommits: 22,
  ...
  },
  {
    ...
    name: 'Senior DevOps & Cloud Engineer (#DEV-106)',
    shortName: 'DEV-106',
    ...
    isSkillsAssessed: true,
    availability: 'In Project',
    availabilityTimeline: 'In Active Client Project (Book Ahead)',
    liveStatusText: 'Active in Client Sprint (90% Bandwidth)',
    lastActiveAgo: 'Just now',
    currentSprintName: 'Sprint #6 • Multi-Region AWS Kubernetes & Terraform',
    weeklyCommits: 52,
  ...
  },
  {
    ...
    name: 'Senior Laravel & PHP Specialist (#DEV-107)',
    shortName: 'DEV-107',
    ...
    availabilityTimeline: 'Immediate (24-48h)',
    liveStatusText: 'Available for Immediate Onboarding',
    lastActiveAgo: '5m ago',
    currentSprintName: 'Ready for Laravel 11 & CodeCanyon Sprint',
    weeklyCommits: 38,
  ...
  },
  {
    ...
    name: 'Lead QA & Test Automation Specialist (#DEV-108)',
    shortName: 'DEV-108',
    ...
    isSkillsAssessed: true,
    availability: 'Available Soon',
    availabilityTimeline: 'Freeing Up Next Week',
    liveStatusText: 'Running E2E Playwright Regression Matrix',
    lastActiveAgo: '8m ago',
    currentSprintName: 'Finalizing Automated Checkout Stress Tests',
    weeklyCommits: 29,
